...
public class MachineRoomMenu extends AbstractContainerMenu {
    ...
    public MachineRoomMenu(int win, String room, LevelBlockPosition machine, String roomName) {
    ...
    public static MenuProvider makeProvider(MinecraftServer server, IRoomRegistration roomInfo, LevelBlockPosition machinePos) {
