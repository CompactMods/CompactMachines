...
public class RoomEventHandler {
    ...
    public static void entityJoined(final EntityJoinWorldEvent evt) {
        ...
        if ((ent instanceof Player) || !ent.level.dimension().equals(Registration.COMPACT_DIMENSION)) return;
    ...
    public static void onCheckSpawn(final LivingSpawnEvent.CheckSpawn evt) {
        ...
        // Early exit if spawning in non-CM dimensions
        if (!ent.level.dimension().equals(Registration.COMPACT_DIMENSION)) return;
