...
public class LegacyMachineLocationsGraph extends SavedData {
    ...
    private final Map<Integer, GlobalPos> machineMapping;
    ...
    public GlobalPos getLocation(int legacyMachineId) {
    ...
    private record MachineData(GlobalPos location, int machine) {
        public static final Codec<MachineData> CODEC = RecordCodecBuilder.create(i -> i.group(
                CodecExtensions.DIMPOS_GLOBALPOS_CODEC.fieldOf("location").forGetter(MachineData::location),
